;(function($){
	var methods = {
		...
		addBtn: function(_property, _page, _count){
			...
			var disabled = '';
			var btnText='';
			var obtLanguage=window.sessionStorage.getItem('obtLanguage')
			...
			return '<a class="'+_property+'" page-id="'+_page+'" '+disabled+'>'+btnText+'</a>';
		},
